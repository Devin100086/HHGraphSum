...
def main():
    ...
    parser.add_argument('--embedding_path', type=str, default='remote-home/dqwang/Glove/glove.42B.300d.txt',
    ...
    parser.add_argument('--test_model', type=str, default='multi',
    ...
    parser.add_argument('--sent_max_len', type=int, default=500,
    ...
    parser.add_argument('--transformer_max_len', type=int, default=150,
                        help='max length of transformer encoder [default: 150]')
    parser.add_argument('--transformer_head', type=int, default=8, help='number of epochs [default: 8]')
    ...
    parser.add_argument('--transformer_num_layers', type=int, default=3,
                        help='layer number of transformer [default: 100]')
    ...
    test_s2s_path = os.path.join(args.cache_dir, "test.s2s.sim.jsonl")
    if hps.model == "HSG":
        ...
        dataset = ExampleSet(DATA_FILE, vocab, hps.doc_max_timesteps, hps.sent_max_len, FILTER_WORD, test_w2s_path,
                             test_s2s_path)
        loader = torch.utils.data.DataLoader(dataset, batch_size=hps.batch_size, shuffle=True, num_workers=32,
